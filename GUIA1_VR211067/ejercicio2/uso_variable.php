    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-12">
                ...
                <p class="lead text-center">A continuación se muestran los valores de las avriables definidas en PHP:</p>
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-tittle">Valor de la variable $a(entero):</h5>
                        <p class="card-text">
                            <?php
                        ...
                        <h5 class="card-tittle">Valor de la variable $b(texto):</h5>
                        <p class="card-text">
                            <?php
                        ...
                        <h5 class="card-tittle">Valor de la variable $c(decimal):</h5>
                        <p class="card-text">
                            <?php
