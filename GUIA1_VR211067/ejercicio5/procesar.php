            ...
            <table class="table table-striped table-bordered">  
                ...
                <tbody> 
                    ...
                    if($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit'])):     
                        ...
                        echo "\t<tr>\n";     
                        echo "\t\t<td>Precio</td>\n";     
                        $precio = !empty($price) ? $price : "<a href='ingresodatos.html' class='text-danger'>No ingresó el precio</a>";     
                        echo "\t\t<td>" . $precio . "</td>\n";
                        echo "\t</tr>\n";     
                        echo "\t<tr>\n";     
                        echo "\t\t<td>Cantidad</td>\n";     
                        $cantidad = !empty($quantity) ? $quantity : "<a href='ingresodatos.html' class='text-danger'>No ingresó la cantidad</a>";     
                        echo "\t\t<td>" . $cantidad . "</td>\n";     
                        echo "\t</tr>\n";     
                        echo "\t<tr>\n";     
