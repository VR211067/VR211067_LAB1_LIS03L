...
<html lang="es"> 
    <head> 
        ...
        <script src="js/modernizr.custom.lis.js"></script> </head> <body> <div class="container"> 
            <header class='navbar navbar-dark bg-dark'> 
                <a class='navbar-brand' class='d-inline-block align-top' href='#'> Cartelera de Cine Bosco </a> 
            </header> 
                <section> 
                    <?php //Creamos una variable con el directorio o carpeta que contiene las imágenes 
                    $dir = "img"; //Creamos una matriz con los nombres de las imágenes que se almacenan en el directorio 
                    $peliculas = array( "al-diablo-con-el-diablo.jpg", "click.jpg", "cruzada.jpg", "efecto-mariposa.jpg", "busca-de-la-felicidad.jpg", "amenaza-fantasma.jpg","la-milla-verde.jpg", "la-propuesta.jpg",  "comunidad-del-anillo.jpg", "sexto-sentido.jpg","Avengers.jpg","Parasite.jpg"     
                                        );     
                    //Obtener cuatro claves de la matriz 
                       
                    $claves = array_rand($peliculas, 4);     //Creando una estructura de 3 columnas con elementos DIV 
                    ?>
