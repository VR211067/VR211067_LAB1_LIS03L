        ...
        <body> 
            ...
            <div class="container"> 
                <header class='navbar navbar-dark bg-dark'> 
                    <a class='navbar-brand' class='d-inline-block align-top' href='#'> Información del formulario </a> 
                </header>      
                <table id="hor-zebra" class="table" summary="Datos recibidos del formulario">               
                    ...
                    <tbody> 
                        <?php     //Obteniendo los datos de la película seleccionada que está almacenada en $seleccionada     
                        $table = "";
                        $i = 1;     
